...
function v(e, t, n, i, r) {
    ...
    for (l && v.removeChild(l), de.appendChecked || pe.grep(h(y, "input"), g), b = 0; (a = y[b++]); )
        ...
        else if (((s = pe.contains(a.ownerDocument, a)), (l = h(v.appendChild(a), "script")), s && m(l), n)) for (o = 0; (a = l[o++]); ) ze.test(a.type || "") && n.push(a);
    return (l = null), v;
}
function y() {
    return !0;
...
function j(e) {
    ...
    return (
        n ||
            ((n = A(e, t)),
            ("none" !== n && n) ||
                ((lt = (lt || pe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement)), (t = (lt[0].contentWindow || lt[0].contentDocument).document), t.write(), t.close(), (n = A(e, t)), lt.detach()),
            (ut[e] = n)),
        n
    );
}
    ...
    for (var n, i, r, o = [], a = 0, s = e.length; s > a; a++)
        (i = e[a]),
            i.style &&
                ...
                (n = i.style.display),
                t
                    ? (o[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && Be(i) && (o[a] = pe._data(i, "olddisplay", j(i.nodeName))))
                    : ((r = Be(i)), ((n && "none" !== n) || !r) && pe._data(i, "olddisplay", r ? n : pe.css(i, "display"))));
...
function O(e, t, n, i, r) {
    for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2)
        "margin" === n && (a += pe.css(e, n + Pe[o], !0, r)),
            i
                ? ("content" === n && (a -= pe.css(e, "padding" + Pe[o], !0, r)), "margin" !== n && (a -= pe.css(e, "border" + Pe[o] + "Width", !0, r)))
                : ((a += pe.css(e, "padding" + Pe[o], !0, r)), "padding" !== n && (a += pe.css(e, "border" + Pe[o] + "Width", !0, r)));
    return a;
}
function M(e, t, n) {
    var i = !0,
                    ...
                    (e = a[i]),
                        ...
                        a !== n &&
                            (u && n && (pe.isPlainObject(n) || (t = pe.isArray(n)))
                                ? (t ? ((t = !1), (o = e && pe.isArray(e) ? e : [])) : (o = e && pe.isPlainObject(e) ? e : {}), (a[i] = pe.extend(u, o, n)))
                                : void 0 !== n && (a[i] = n));
        return a;
    }),
    pe.extend({
        ...
        (_ = t.setDocument = function (e) {
            ...
            return i !== D && 9 === i.nodeType && i.documentElement
                ? ((D = i),
                    ...
                    (w.matchesSelector = ge.test((P = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector))) &&
                        r(function (e) {
                        ...
                        : function (t, n, l) {
                                ...
                                if (g) {
                                    ...
                                    if (((h = [a ? g.firstChild : g.lastChild]), a && y)) {
                                        for (
                                            f = g, d = f[F] || (f[F] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [], p = u[0] === $ && u[1], b = p && u[2], f = p && g.childNodes[p];
                                        ...
                                        for (
                                            ;
                                            (f = (++p && f && f[m]) || (b = p = 0) || h.pop()) &&
                                            ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && ((d = f[F] || (f[F] = {})), (c = d[f.uniqueID] || (d[f.uniqueID] = {})), (c[e] = [$, b])), f !== t));
    ...
    return (
        ...
        (E = t.tokenize = function (e, n) {
            ...
            for (s = e, l = [], u = C.preFilter; s; ) {
                (i && !(r = le.exec(s))) || (r && (s = s.slice(r[0].length) || s), l.push((o = []))), (i = !1), (r = ue.exec(s)) && ((i = r.shift()), o.push({ value: i, type: r[0].replace(se, " ") }), (s = s.slice(i.length)));
                for (a in C.filter) !(r = pe[a].exec(s)) || (u[a] && !(r = u[a](r))) || ((i = r.shift()), o.push({ value: i, type: a, matches: r }), (s = s.slice(i.length)));
                if (!i) break;
            }
            ...
            for (
                ...
                (o = Je.exec(t[s]) || []),
                    ...
                    p &&
                        ...
                        (u = pe.event.special[p] || {}),
                        (d = pe.extend({ type: p, origType: m, data: i, handler: n, guid: n.guid, selector: r, needsContext: r && pe.expr.match.needsContext.test(r), namespace: h.join(".") }, l)),
                        (f = a[p]) || ((f = a[p] = []), (f.delegateCount = 0), (u.setup && u.setup.call(e, i, h, c) !== !1) || (e.addEventListener ? e.addEventListener(p, c, !1) : e.attachEvent && e.attachEvent("on" + p, c))),
        ...
        if (
            ...
            for (d = 0; (s = f[d++]) && !t.isPropagationStopped(); )
                (t.type = d > 1 ? l : u.bindType || p),
                    ...
                    o && o.apply(s, n),
                    (o = a && s[a]),
                    o && o.apply && De(s) && ((t.result = o.apply(s, n)), t.result === !1 && t.preventDefault());
    ...
    ? ((ht = function (t) {
        ...
        (mt = function (e, t, n) {
            ...
            return (
                ...
                n && !de.pixelMarginRight() && dt.test(a) && ct.test(t) && ((i = s.width), (r = s.minWidth), (o = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = i), (s.minWidth = r), (s.maxWidth = o)),
                void 0 === a ? a : a + ""
            );
        }))
    : pt.currentStyle &&
        ...
        (mt = function (e, t, n) {
            ...
            return (
                ...
                (a = n ? n[t] : void 0),
                null == a && s && s[t] && (a = s[t]),
                dt.test(a) && !gt.test(t) && ((i = s.left), (r = e.runtimeStyle), (o = r && r.left), o && (r.left = e.currentStyle.left), (s.left = "fontSize" === t ? "1em" : a), (a = s.pixelLeft + "px"), (s.left = i), o && (r.left = o)),
                void 0 === a ? a : a + "" || "auto"
            );
        }));
var vt = /alpha\([^)]*\)/i,
...
pe.extend({
    ...
    style: function (e, t, n, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            ...
            if (
                ((o = typeof n),
                "string" === o && (r = Me.exec(n)) && r[1] && ((n = f(e, t, r)), (o = "number")),
                null != n &&
                    n === n &&
...
(pe.Animation = pe.extend(R, {
    ...
    pe.each({ slideDown: F("show"), slideUp: F("hide"), slideToggle: F("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, t) {
...
pe.fn.extend({
    val: function (e) {
        ...
        return arguments.length
            ...
            : r
            ? ((t = pe.valHooks[r.type] || pe.valHooks[r.nodeName.toLowerCase()]), t && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : ((n = r.value), "string" == typeof n ? n.replace(At, "") : null == n ? "" : n))
            : void 0;
    },
}),
    pe.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return "undefined" == typeof e.getAttribute
                    ? pe.prop(e, t, n)
                    : ((1 === o && pe.isXMLDoc(e)) || ((t = t.toLowerCase()), (r = pe.attrHooks[t] || (pe.expr.match.bool.test(t) ? Dt : _t))),
                        void 0 !== n
                            ? null === n
...
pe.fn.extend({
    ...
    toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && "string" === n
            ...
            : this.each(function () {
                    var t, i, r, o;
                    if ("string" === n) for (i = 0, r = pe(this), o = e.match(Ae) || []; (t = o[i++]); ) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
    ...
    ajax: function (t, n) {
        function i(t, n, i, r) {
            ...
            2 !== x &&
                ...
                (b = G(f, b, C, o)),
                o
                    ? (f.ifModified && ((w = C.getResponseHeader("Last-Modified")), w && (pe.lastModified[a] = w), (w = C.getResponseHeader("etag")), w && (pe.etag[a] = w)),
                        204 === t || "HEAD" === f.type ? (T = "nocontent") : 304 === t ? (T = "notmodified") : ((T = b.state), (d = b.data), (y = b.error), (o = !y)))
                ...
                g.fireWith(p, [C, T]),
                u && (h.trigger("ajaxComplete", [C, f]), --pe.active || pe.event.trigger("ajaxStop")));
        }
        ...
        if (
            ...
            (f.dataTypes = pe
                ...
                .toLowerCase()
                .match(Ae) || [""]),
            null == f.crossDomain && ((r = Qt.exec(f.url.toLowerCase())), (f.crossDomain = !(!r || (r[1] === tn[1] && r[2] === tn[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (tn[3] || ("http:" === tn[1] ? "80" : "443")))))),
        ...
        (u = pe.event && f.global),
            ...
            (a = f.url),
            f.hasContent || (f.data && ((a = f.url += (zt.test(a) ? "&" : "?") + f.data), delete f.data), f.cache === !1 && (f.url = Xt.test(a) ? a.replace(Xt, "$1_=" + $t++) : a + (zt.test(a) ? "&" : "?") + "_=" + $t++)),
            f.ifModified && (pe.lastModified[a] && C.setRequestHeader("If-Modified-Since", pe.lastModified[a]), pe.etag[a] && C.setRequestHeader("If-None-Match", pe.etag[a])),
    ...
    (x.prototype = {
        ...
        open: function (n) {
            ...
            E("BeforeOpen"),
                ...
                (t.st.fixedBgPos === !1 || ("auto" === t.st.fixedBgPos && !t.fixedContentPos)) && t.bgOverlay.css({ height: r.height(), position: "absolute" }),
            ...
            getImage: function (n, i) {
                var r = 0,
                    o = function () {
                        n &&
                            (n.img[0].complete
                                ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), (n.hasSize = !0), (n.loaded = !0), E("ImageLoadComplete"))
                ...
                this.each(function () {
                    ...
                    if (this !== document && this !== window)
                        return !document.scrollingElement || (this !== document.documentElement && this !== document.body)
                            ? void (t[r]() > 0 ? n.push(this) : (t[r](1), (i = t[r]() > 0), i && n.push(this), t[r](0)))
    ...
    e.fn.extend({
        ...
        smoothScroll: function (t, n) {
            ...
            var i = e.extend({}, e.fn.smoothScroll.defaults, t),
                r = function (t) {
                    ...
                    d && (a.preventDefault && t.preventDefault(), e.extend(f, a, { scrollTarget: a.scrollTarget || v, link: r }), e.smoothScroll(f));
                };
        ...
        (e.smoothScroll = function (t, i) {
            ...
            var r,
                ...
                p = {};
            "number" == typeof t
                ? ((r = e.extend({ link: null }, e.fn.smoothScroll.defaults, n)), (a = t))
                : ((r = e.extend({ link: null }, e.fn.smoothScroll.defaults, t || {}, n)), r.scrollElement && ((c = "position"), "static" === r.scrollElement.css("position") && r.scrollElement.css("position", "relative"))),
                (d = "left" === r.direction ? "scrollLeft" : d),
                r.scrollElement ? ((o = r.scrollElement), /^(?:HTML|BODY)$/.test(o[0].nodeName) || (u = o[d]())) : (o = e("html, body").firstScrollable(r.direction)),
                r.beforeScroll.call(o, r),
                (a = "number" == typeof t ? t : i || (e(r.scrollTarget)[c]() && e(r.scrollTarget)[c]()[r.direction]) || 0),
                (f[d] = a + u + r.offset),
                (s = r.speed),
                "auto" === s && ((l = Math.abs(f[d] - o[d]())), (s = l / r.autoCoefficient)),
                (p = {
                    duration: s,
                    easing: r.easing,
                    complete: function () {
...
!(function (e, t) {
    ...
    function y(e) {
        ...
        var a = { top: t.top, marginTop: t.marginTop, marginBottom: t.marginBottom, marginLeft: t.marginLeft, marginRight: t.marginRight, cssFloat: t.cssFloat, display: t.display },
            s = { top: r(t.top), marginBottom: r(t.marginBottom), paddingLeft: r(t.paddingLeft), paddingRight: r(t.paddingRight), borderLeftWidth: r(t.borderLeftWidth), borderRightWidth: r(t.borderRightWidth) };
        e.style.position = o;
        var l = {
            ...
            d = {
                ...
                numeric: { borderLeftWidth: r(i.borderLeftWidth), borderRightWidth: r(i.borderRightWidth), borderTopWidth: r(i.borderTopWidth), borderBottomWidth: r(i.borderBottomWidth) },
            },
            f = {
                node: e,
                ...
                inited: !1,
                parent: d,
                limit: { start: u.doc.top - s.top, end: c.doc.top + n.offsetHeight - d.numeric.borderBottomWidth - e.offsetHeight - s.top - s.marginBottom },
            };
        return f;
    }
    function b(e) {
...
var tablink = document.getElementsByClassName('tablinks')[0]
