...
<div class="research-block">
	...
	<div class="right">
		...
		<span class="research-text">My mother being a special educator has given me the opportunity to have interactions with visual impaired students at her school. In multiple interactions with visually impaired students at school where my mother teaches and individuals within my society, a recurring difficulty emerged that despite the development of numerous assistive devices over the years, due to various limitations, still numerous visually impaired individuals in India don’t have a navigational assistive tool/device. After reviewing related literature, informal discussions and a formal survey conducted at Raghuveer Singh Memorial Blind Trust in Shahdara, Delhi, my comprehension significantly improved about this problem. To address it, I developed an initial-stage low cost eye-wear assitive device and conducted test with a group of visually impaired participants. This work is started as part of my Final-year College Project and I am actively working to improve this solution.</span>
	</div>
</div>
