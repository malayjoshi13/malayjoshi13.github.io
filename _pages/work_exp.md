...
<div class="research-block">
	...
	<div class="right">
		...
		<li style="text-align: justify; font-size: 14px;"> Developed PoCs using <b>image-to-image text style transfer</b> models to generate images with <b>specific font-styled textual content</b> and <b>text-to-image-to-video</b> models to <b>generate visual storyboards</b> based on a textual context.</li> 
